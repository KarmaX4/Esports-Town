  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Moderator Details</li>
      </ol>
    </section>
        ...
        <div class="box-body">
          ...
          ?>
            <table class="table table-bordered table-hover">
                <tr>
                    <td class="col-md-6">Moderator Name</td>
        ...
        <div class="box-body" id="screendtls">
          ...
          ?>
            <table class="table table-bordered table-hover">
              ...
              <th class="col-md-3">Match Time</th>
              <th class="text-right col-md-3"><button data-toggle="modal" data-target="#view-modal" id="getUser" class="btn btn-sm btn-info"><i class="fa fa-plus"></i> Add Screen</button></th>
                ...
                while($screen=mysqli_fetch_array($sr))
                {
                  ...
                  <tr>
                    ...
                    {echo "No Match Time Added";}
                    ?></td>
                    <td class="text-right"><button data-toggle="modal" data-id="<?php echo $screen['screen_id'];?>" data-target="#view-modal2" id="getUser2" class="btn btn-sm btn-warning"><i class="fa fa-plus"></i> Add match Times</button></td>
                  </tr>
                  <?php
                  $sl++;
                }
             ...
             <div class="modal-dialog"> 
                  <div class="modal-content"> 
                       ...
                       <div class="modal-header"> 
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">
                            	<i class="fa fa-plus"></i> Add match Time
                            </h4> 
                       </div> 
                       <div class="modal-body"> 
                           <div class="form-group">
                       	     <label class="control-label">Select match</label>
                       	   ...
                       	   <div class="form-group">
                       	     <label class="control-label">Match Starting Time</label>
