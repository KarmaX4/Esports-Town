...
<head>
  ...
  <title>Moderator Assistance</title>
  <!-- valodation -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>Moderator</b> Assistant</span>
    </a>
      ...
      <ul class="sidebar-menu">
        <li class="treeview">
          ...
          <a href="add_movie.php">
            <i class="fa fa-plus"></i> <span>Add Game</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="add_show.php">
            <i class="fa fa-ticket"></i> <span>Add Match</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="todays_shows.php">
            <i class="fa fa-calendar"></i> <span>Todays Matches</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="view_shows.php">
            <i class="fa fa-eye"></i> <span>View Matches</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="add_theatre_2.php">
            <i class="fa fa-film"></i> <span>Moderator Details</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
