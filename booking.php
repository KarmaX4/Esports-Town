						...
						<h3><?php echo $movie['movie_name']; ?></h3>	
							<div class="about-top">	
								...
								<div class="desc span_3_of_2">
									<p class="p-link" style="font-size:15px">Type : <?php echo $movie['cast']; ?></p>
									<p class="p-link" style="font-size:15px">Launch Date : <?php echo date('d-M-Y',strtotime($movie['release_date'])); ?></p>
							...
							<div class="col-md-12 text-center" style="padding-bottom:20px">
								...
								?>
									...
									<tr>
										...
										<td>
											<?php echo date('h:i A',strtotime($ttme['start_time']))." ".$ttme['name'];?> match
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											...
											<input type="number" required tile="number of slots" max="<?php echo $screen['seats']-$avl[0];?>" min="0" name="seats" class="form-control" value="1" style="text-align:center" id="seats"/>
